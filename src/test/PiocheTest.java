...
public class PiocheTest
{
	...
	{
		assertEquals(pioche1.piger(), new Carte(ValeurCartes.V_AS, SorteCartes.PIQUE));
		assertEquals(pioche1.piger(), new Carte(ValeurCartes.V_AS, SorteCartes.COEUR));
		assertEquals(pioche1.piger(), new Carte(ValeurCartes.V_AS, SorteCartes.TREFLE));
		assertEquals(pioche1.piger(), new Carte(ValeurCartes.V_AS, SorteCartes.CARREAU));
		assertEquals(pioche1.piger(), new Carte(ValeurCartes.V_2, SorteCartes.PIQUE));
		assertEquals(pioche1.piger(), new Carte(ValeurCartes.V_2, SorteCartes.COEUR));
		assertEquals(pioche1.piger(), new Carte(ValeurCartes.V_2, SorteCartes.TREFLE));
		assertEquals(pioche1.piger(), new Carte(ValeurCartes.V_2, SorteCartes.CARREAU));
